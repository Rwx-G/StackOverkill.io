...
import { ArrowLeft, Zap, AlertTriangle, RefreshCw, Home } from 'lucide-react';
    ...
    <div className="h-screen flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4">
        <div className="text-center max-w-md">
          {/* Error Icon */}
          <div className="mb-6 inline-flex items-center justify-center w-20 h-20 bg-red-500/10 backdrop-blur-sm rounded-full border border-red-500/20">
          ...
          <p className="text-slate-400 mb-8">
            ...
            Pas d'inquietude, ca arrive meme aux meilleures infras !
          </p>
